		...
		<div class="user-info-list">
			<div class="user-info-left">
				<div class="user-info-title">
					<div :class="index == userTabActive ? 'user-tab-item user-tab-active':'user-tab-item'"
						v-for="(item,index) in userTabList" @click="userTabActive = index">{{item.name}}</div>
				</div>
				<div class="user-info-body">
					...
					<div class="page">
						<a-pagination size="small" :total="50" :show-total="total => `共 ${total} 条数据`"
							show-quick-jumper />
					</div>
				</div>
			</div>
